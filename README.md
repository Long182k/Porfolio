<h1 align="center">Welcome to Drake's Portfolio 👋</h1>

## Software Developer Portfolio Template built with Next.js, bootstrap that helps you showcase your work and skills as a software developer.

<p align="center">
  <kbd>
    <img src="https://github.com/Long182k/Porfolio/blob/master/background_porfolio.png"></img>
  </kbd>
</p>

## To view a live example, **[click here](https://drake-porfolio.vercel.app/)**.
...
```bash
$ git clone https://github.com/Long182k/Porfolio.git
```
...
- Website: https://drake-porfolio.vercel.app/
- Github: [@DrakeDev](https://github.com/Long182k)
- LinkedIn: [@LongNguyen](https://www.linkedin.com/in/drakenguyen1820/)
